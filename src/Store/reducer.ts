...
const initialState: CarState = {
    cars: [
        {id: 1, isActive: false, brand: 'Porsche', model: 'Panamera', carNumber: 'x181xx74', date: '02.01.2001'},
        {id: 2, isActive: true, brand: 'Audi', model: 'A7', carNumber: 'x281xx74', date: '03.01.2001'},
        {id: 3, isActive: true, brand: 'Audi', model: 'Q3', carNumber: 'x381xx74', date: '04.01.2001'},
        {id: 4, isActive: false, brand: 'VW', model: 'Golf R', carNumber: 'x481xx74', date: '08.01.2001'},
        {id: 5, isActive: true, brand: 'Skoda', model: 'Rapid', carNumber: 'x581xx74', date: '10.01.2001'},
